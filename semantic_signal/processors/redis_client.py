"""
Redis client for message queue and caching in the semantic signal generator.
"""
...
class RedisCache:
    ...
    def __init__(self, prefix: str = "semantic_cache"):
...
text_queue = RedisQueue("semantic_text_queue")
entity_queue = RedisQueue("semantic_entity_queue")
event_queue = RedisQueue("semantic_event_queue")
sentiment_queue = RedisQueue("semantic_sentiment_queue")
signal_queue = RedisQueue("semantic_signal_queue")

llm_cache = RedisCache("semantic_llm_cache")
entity_cache = RedisCache("semantic_entity_cache")
event_cache = RedisCache("semantic_event_cache")
sentiment_cache = RedisCache("semantic_sentiment_cache")
signal_cache = RedisCache("semantic_signal_cache")
