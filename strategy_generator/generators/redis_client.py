"""
Redis client for message queue and caching in the strategy generator.
"""
...
class RedisCache:
    ...
    def __init__(self, prefix: str = "strategy_cache"):
...
strategy_queue = RedisQueue("strategy_queue")
backtest_queue = RedisQueue("backtest_queue")
optimization_queue = RedisQueue("optimization_queue")
signal_queue = RedisQueue("strategy_signal_queue")

strategy_cache = RedisCache("strategy_cache")
backtest_cache = RedisCache("backtest_cache")
optimization_cache = RedisCache("optimization_cache")
signal_cache = RedisCache("strategy_signal_cache")
market_data_cache = RedisCache("market_data_cache")
